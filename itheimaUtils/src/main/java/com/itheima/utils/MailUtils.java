...
public class MailUtils {
    ...
    public static final String USERNAME = "J1uj1u_tty686@163.com";
    // 发件人邮箱的密码.例如 password
    public static final String PASSWORD = "tty520";
    // 发件人邮箱地址.例如 zhangsan@qq.com
    public static final String SENDER = "J1uj1u_tty686@163.com";
