...
/**  
 * ClassName:ConmonAction <br/>  
 * Function:  <br/>  
 * Date:     2018年3月16日 下午2:58:50 <br/>       
 */
public class ConmonAction<T> extends ActionSupport implements ModelDriven<T> {
    
	private T model;
	private Class<T> clazz;
	
	public ConmonAction(Class<T> clazz) {
